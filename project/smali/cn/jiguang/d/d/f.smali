...
.method public dispatchMessage(Landroid/content/Context;JILjava/lang/Object;Ljava/nio/ByteBuffer;)J
    ...
    const-string p2, "Action - receivedCommand unexcepted - response was null"
    ...
    :cond_0
    const-string p5, "JCoreAction"

    new-instance p6, Ljava/lang/StringBuilder;

    const-string v0, "Action - handResponse  response:"
    ...
    invoke-static {p5, p6}, Lcn/jiguang/e/d;->b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string p3, "sendToThird response command - "
    ...
    invoke-virtual {p2, p1, p5, p6, p3}, Lcn/jiguang/d/d/e;->a(Landroid/content/Context;JI)V
...
.method public dispatchTimeOutMessage(Landroid/content/Context;JJI)V
    ...
    invoke-virtual {p2, p1, p4, p5}, Lcn/jiguang/d/d/e;->b(Landroid/content/Context;J)V
...
.method public onActionRun(Landroid/content/Context;JLandroid/os/Bundle;Ljava/lang/Object;)V
    ...
    const-string p5, "Service bundle - "
    ...
    :cond_2
    const-string p1, "ARunAction"

    const-string p2, "onRunAction bundle is null"
